...
//    }
    ...
    ResponseEntity<ApiResponse> handlingMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        try {
            ...
            // Lấy các thuộc tính của ràng buộc, ví dụ như giá trị tối thiểu (min), trả về một Map<String, Object> chứa các thuộc tính và giá trị tương ứng của chúng. vd: {min=5}
    ...
    // Đây là một phương thức xử lý ngoại lệ chung cho tất cả các loại ngoại lệ không được xử lý cụ thể khác. Khi một ngoại lệ không được xử lý bởi các phương thức trước đó, nó sẽ được chuyển đến phương thức này để xử lý.
