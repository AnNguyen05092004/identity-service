...
// Tự động tạo constructor với tất cả các trường được đánh dấu là final => không cần phải sử dụng @Autowired nữa, Spring sẽ tự động inject các dependency thông qua constructor
