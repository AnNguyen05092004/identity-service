...
public interface UserMapper {
    ...
    @Mapping(target = "roles", ignore = true) // Bỏ qua trường roles khi cập nhật, vì chúng ta sẽ không cập nhật roles thông qua UserUpdateRequest
    void updateUser(@MappingTarget User user, UserUpdateRequest userUpdateRequest);

    //@Mapping(source = "firstName", target = "lastName") // Để map trường firstName của User sang lastName của UserResponse
